...
#     # datasets would be present & multiscales is a list
#     with zarr.open(attrs_path) as metadata:
#         scale_img = metadata.attrs["multiscales"][dataset]["datasets"][
#             level][
...
#     # Load labels
#     img_data_zyx = da.from_zarr(f"{zarr_url}/{well}/{image_index}/{level}")[
#         channel_index
#     ]
...
#         feature_df[feature] - lower_contrast_limit
